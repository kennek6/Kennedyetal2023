...
listVars <- c("age", "para", "gravida", "BMI_SM0", "weight_gain", "gain_cat", "weight_retained",
              "dG", "modeSimple", "BMI_cat_0" #, "sex",
              #"baby_weight", 'baby_height', "weight_height_ratio_0", 
              #"perc_voigt_weight", "perc_voigt_height"#,
              #"weight_child_5", 'height_child_5','BMI_child_5', "placentalweight",  "FP_ratio", 
              )
```
...
gt::gtsave(table, here::here("results", "ExtendedDataTable1.html"))

#save_as_docx(table, path = here::here("results", "table_S1.docx"))
```
